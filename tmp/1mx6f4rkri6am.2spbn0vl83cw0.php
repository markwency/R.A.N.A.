...
<head>
  ...
  <body>
    <ul>
      <p>Retrospective Artificially intelligent Network Assistant</p>
      ...
      <li><a id="cashLoanButton" class="waves-effect waves-light inquiryButton btn">Cash Loan</a></li>
      <li><a id="osamButton" class="waves-effect waves-light inquiryButton btn">OSAM</a></li>
      <li><a id="regButton" class="waves-effect waves-light inquiryButton btn">Registration</a></li>
      <li><a id="studActButton" class="waves-effect waves-light inquiryButton btn">Student Activity</a></li>
      <li><a id="scholarshipButton" class="waves-effect waves-light inquiryButton btn">Scholarship</a></li>
